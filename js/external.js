...
let littleMermaidDays = 3,
    ...
    pricePerDay = 3,
    totalRentalPrice = (littleMermaidDays + brotherBearDays + herculesDays) * pricePerDay;
console.log("You owe " + totalRentalPrice + " for your movie rentals!");
...
console.log("It is " + canEnrollInClass + " that you can enroll in this class.");
...
let itemsPurchased = prompt("How many items did you purchase?"),
    ...
    productOfferIsApplied = (itemsPurchased > 2 || isPremiumMember) && offerNotExpired;
console.log("It is " + productOfferIsApplied + " that the offer can be applied.");
